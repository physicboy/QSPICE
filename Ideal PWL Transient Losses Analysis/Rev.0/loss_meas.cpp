...
extern "C" __declspec(dllexport) void loss_meas(struct sLOSS_MEAS **opaque, double t, union uData *data)
{
   ...
   double       rgon          = data[ 3].d  ; // input parameter
   double       rgoff         = data[ 4].d  ; // input parameter
   const char * fname         = data[ 5].str; // input parameter
   double       dtime         = data[ 6].d  ; // input parameter
   double       Npara         = data[ 7].d  ; // input parameter
   double       Rds_factor    = data[ 8].d  ; // input parameter
   double       Pon_factor    = data[ 9].d  ; // input parameter
   double       Poff_factor   = data[10].d  ; // input parameter
   double       Pcoss_factor  = data[11].d  ; // input parameter
   double       Pdt_factor    = data[12].d  ; // input parameter
   double      &pon           = data[13].d  ; // output
   double      &poff          = data[14].d  ; // output
   double      &pcond         = data[15].d  ; // output
   double      &pdt           = data[16].d  ; // output
   double      &pcoss         = data[17].d  ; // output
   double      &pdevice       = data[18].d  ; // output
   double      &ptotal        = data[19].d  ; // output
...
// Implement module evaluation code here:
   ...
   if(inst->gate_p1 < inst->gate_p2)
   {
      ...
      inst->pcond = inst->mult_vi_int / period;
      inst->mult_vi_int = 0;
